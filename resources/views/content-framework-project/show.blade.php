...
@section('title', 'View Content Framework Project')
...
<strong>Content Framework Id:</strong>
{{ $contentFrameworkProject->content_framework_id }}
</div>
<div class="form-group">
<strong>Project Id:</strong>
{{ $contentFrameworkProject->project_id }}
</div>
