...
-- Docker
-- Create a basic user for login
CREATE USER IF NOT EXISTS 'db_user'@'172.21.0.8' IDENTIFIED BY '{{DB_USER_PASS}}';
-- Database connection permission
GRANT USAGE ON *.* TO 'db_user'@'172.21.0.8';

-- Basic users can:
GRANT SELECT ON {{DB_DATABASE}}.users TO 'db_user'@'172.21.0.8';
-- GRANT SELECT, INSERT, UPDATE, DELETE ON {{DB_DATABASE}}.password_resets TO 'db_user'@'172.21.0.8';
-- GRANT SELECT, INSERT, UPDATE, DELETE ON {{DB_DATABASE}}.password_reset_tokens TO 'db_user'@'172.21.0.8';
-- GRANT SELECT, INSERT, UPDATE, DELETE ON {{DB_DATABASE}}.personal_access_tokens TO 'db_user'@'172.21.0.8';
-- GRANT SELECT, INSERT, UPDATE, DELETE ON {{DB_DATABASE}}.sessions TO 'db_user'@'172.21.0.8';

-- Create user for students
CREATE USER IF NOT EXISTS 'db_student'@'172.21.0.8' IDENTIFIED BY '{{DB_STUDENT_PASS}}';
-- Database connection permission
GRANT USAGE ON *.* TO 'db_student'@'172.21.0.8';

-- Students can:
GRANT SELECT ON {{DB_DATABASE}}.departments TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.cities TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.city_program TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.programs TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.research_groups TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.investigation_lines TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.thematic_areas TO 'db_student'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.projects TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.project_statuses TO 'db_student'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.content_framework_project TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.content_frameworks TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.frameworks TO 'db_student'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.versions TO 'db_student'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.content_version TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.contents TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.professors TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.professor_project TO 'db_student'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.students TO 'db_student'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.student_project TO 'db_student'@'172.21.0.8';
GRANT SELECT, UPDATE ON {{DB_DATABASE}}.users TO 'db_student'@'172.21.0.8';

---- ======================================
--
---- Create user for professors
CREATE USER IF NOT EXISTS 'db_professor'@'172.21.0.8' IDENTIFIED BY '{{DB_PROFESSOR_PASS}}';
GRANT USAGE ON *.* TO 'db_professor'@'172.21.0.8';
--
---- Professors can:
GRANT SELECT ON {{DB_DATABASE}}.departments TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.cities TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.city_program TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.programs TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.research_groups TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.investigation_lines TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.thematic_areas TO 'db_professor'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.projects TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.project_statuses TO 'db_professor'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.content_framework_project TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.content_frameworks TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.frameworks TO 'db_professor'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.versions TO 'db_professor'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.content_version TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.contents TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.professors TO 'db_professor'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.professor_project TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.students TO 'db_professor'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.student_project TO 'db_professor'@'172.21.0.8';
GRANT SELECT, UPDATE ON {{DB_DATABASE}}.users TO 'db_professor'@'172.21.0.8';
--
---- ======================================
--
---- Create a user for research_staff
CREATE USER IF NOT EXISTS 'db_research_staff'@'172.21.0.8' IDENTIFIED BY '{{DB_RESEARCH_PASS}}';
GRANT USAGE ON *.* TO 'db_research_staff'@'172.21.0.8';
--
---- Research staff can:
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.departments TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.cities TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.city_program TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.programs TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.research_groups TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.investigation_lines TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.thematic_areas TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, UPDATE ON {{DB_DATABASE}}.projects TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.project_statuses TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.content_framework_project TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.content_frameworks TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.frameworks TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.versions TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.content_version TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.contents TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.professors TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT ON {{DB_DATABASE}}.professor_project TO 'db_research_staff'@'172.21.0.8';
GRANT SELECT, INSERT, UPDATE ON {{DB_DATABASE}}.students TO 'db_research_staff'@'172.21.0.8';
