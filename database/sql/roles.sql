...
GRANT SELECT ON {{DB_DATABASE}}.project_status TO 'db_student'@'%';
...
GRANT SELECT ON {{DB_DATABASE}}.project_status TO 'db_professor'@'%';
...
GRANT SELECT ON {{DB_DATABASE}}.project_status TO 'db_research_staff'@'%';
